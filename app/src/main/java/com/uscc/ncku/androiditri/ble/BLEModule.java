...
public class BLEModule {
    public static final String ERROR_BLE_NOT_SUPPORTED = "Bluetooth not supported.";

    public static final int BLE_SCAN_DONE = 1;
    public static final int BLE_LOW_POWER_WARNING = 2;
