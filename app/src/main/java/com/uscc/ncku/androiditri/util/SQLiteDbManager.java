...
public class SQLiteDbManager extends SQLiteOpenHelper{
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        String DB_CREATE_TABLE_PROJECT = "CREATE TABLE " + DatabaseUtilizer.PROJECT_TABLE + " ("
                ...
                + ")";
        // beacon
        String DB_CREATE_TABLE_BEACON = "CREATE TABLE " + DatabaseUtilizer.BEACON_TABLE + " ("
                + "_ID INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL,"
                + DatabaseUtilizer.BEACON_ID + " INT,"
                + DatabaseUtilizer.MAC_ADDR + " TEXT,"
                + DatabaseUtilizer.NAME + " TEXT,"
                + DatabaseUtilizer.INTRODUCTION + " TEXT,"
                + DatabaseUtilizer.BEACON_POWER + " INT,"
                + DatabaseUtilizer.BEACON_STATUS + " INT,"
                + DatabaseUtilizer.BEACON_ZONE + " INT,"
                + DatabaseUtilizer.X + " INT,"
                + DatabaseUtilizer.Y + " INT"
                + ")";
        // company
        String DB_CREATE_TABLE_COMPANY = "CREATE TABLE " + DatabaseUtilizer.COMPANY_TABLE + " ("
                + "_ID INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL,"
                + DatabaseUtilizer.COMPANY_ID + " INT,"
                + DatabaseUtilizer.NAME + " TEXT,"
                + DatabaseUtilizer.COMPANY_TEL + " TEXT,"
                + DatabaseUtilizer.COMPANY_FAX + " TEXT,"
                + DatabaseUtilizer.COMPANY_ADDR + " TEXT,"
                + DatabaseUtilizer.COMPANY_WEB + " TEXT,"
                + DatabaseUtilizer.QRCODE+ " TEXT"
                + ")";
        // field map
        String DB_CREATE_TABLE_FIELD_MAP = "CREATE TABLE " + DatabaseUtilizer.FIELD_MAP_TABLE + " ("
                + "_ID INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL,"
                + DatabaseUtilizer.FIELD_MAP_ID + " INT,"
                + DatabaseUtilizer.NAME + " TEXT,"
                + DatabaseUtilizer.NAME_EN + " TEXT,"
                + DatabaseUtilizer.PROJECT_ID + " INT,"
                + DatabaseUtilizer.INTRODUCTION + " TEXT,"
