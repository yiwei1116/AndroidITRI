...
public class SQLiteDbManager extends SQLiteOpenHelper{
    ...
    public void onCreate(SQLiteDatabase db) {
        String DB_CREATE_TABLE_DEVICE = "CREATE TABLE" + DatabaseUtilizer.DEVICE_TABLE + " ("
                ...
                + DatabaseUtilizer.DEVICE_NAME + " TEXT,"
                + DatabaseUtilizer.DEVICE_NAME_EN + " TEXT,"
                + DatabaseUtilizer.DEVICE_INTRODUCTION + " TEXT,"
                + DatabaseUtilizer.DEVICE_GUIDE_VOICE + " TEXT,"
                ...
                + DatabaseUtilizer.DEVICE_READ_COUNT + " INT"
                + ")";
